...
The local command run on 2026-09-24 passed all nine tests with Python 3.12.8, Bash 3.2.57, Zsh 5.9, and PowerShell 7.6.4. The associated pull request links the exact source SHA and hosted workflow run; reports are retained as CI artifacts.
